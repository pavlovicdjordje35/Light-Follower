...
{
    FL = (float)ADCBUF0 / MAX_ADC_VALUE; // naponski razdelnik
    FR = (float)ADCBUF1 / MAX_ADC_VALUE;
    BL = (float)ADCBUF2 / MAX_ADC_VALUE;
    BR = (float)ADCBUF3 / MAX_ADC_VALUE;
...
int main(int argc, char** argv) {
    ...
    memset(word_start, 0, sizeof(word_start));  
    position_UART2 = 0;
    WriteStringUART2("Write STOP to stop :D.");
    WriteCharUART2(13);
    while (word_start[0]!='S' 
        || word_start[1]!='T'
        || word_start[2]!='O'
    ...
    WriteStringUART2("The car STOPED.");
    WriteCharUART2(13);
    }
